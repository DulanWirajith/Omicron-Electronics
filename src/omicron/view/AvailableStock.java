 ...
 * @author Dulan
 */
public class AvailableStock extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Available Stock Sub Items...");
    ...
    private void getRe_OrderItems() {
        try {
            ArrayList<Batch> allRe_OrderLevelItems = BatchController.getAvailableStock();
            ...
            Logger.getLogger(AvailableStock.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void print() {
        try {
            InputStream inputStream = getClass().getResourceAsStream("AllStock.jrxml");
